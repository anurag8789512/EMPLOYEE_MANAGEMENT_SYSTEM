...
public class addempproj extends JFrame implements ActionListener{
    
    JTextField desig1,address1,salary1,phno1,adhno1,var1;
    JLabel empid,adhnol1;
    JButton det,back;
    String empid1;
    addempproj(String empid1){
        this.empid1=empid1;
        setLayout(null);
        setTitle("ADD EMPLOYEE PROJECT");
        ...
        JLabel title=new JLabel("Add Employee Project");
        ...
        JLabel salary=new JLabel("Project Location");
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource()==det){
            ...
            try{
            Conn c=new Conn();
            String query="insert into project values('"+empid2+"','"+desig2+"','"+dname2+"','"+dloc2+"')";
