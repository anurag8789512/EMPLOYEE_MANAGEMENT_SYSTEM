...
public class addempskill extends JFrame implements ActionListener,ItemListener{
    ...
    JButton det,back;
    String empid1;
    addempskill(String empid1){
        setTitle("ADD EMPLOYEE SKILL");
        hm=new HashMap<>();
        hm.put("Java", "1s001");
        hm.put("Python", "1s002");
        hm.put("C", "1s003");
        ...
        JLabel title=new JLabel("Add Employee Skill");
        title.setBounds(800,20,500,40);
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource()==det){
            ...
            Conn conn= new Conn();
            try{
                String query="insert into skills values('"+empid2+"','"+skillid2+"','"+faname2+"','"+salary2+"')";
